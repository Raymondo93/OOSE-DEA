 ...
 */
	...
	{	g.setFont(displayfont);
		...
		// --- rood ----
		c = new Color(kleur.getRoodValue(), 0, 0);
		paintKleurComponent("Rood", c, echtRood, 270, 20, g);
		// --- groen ----
		c = new Color(0, kleur.getGroenValue(), 0);
		paintKleurComponent("Groen", c, echtGroen, 270, 100, g);
		// --- blauw ----
		c = new Color(0, 0, kleur.getBlauwValue());
		paintKleurComponent("Blauw", c, echtBlauw, 270, 180, g);

		// --- menging ----
		g.setColor(new Color(kleur.getRoodValue(), kleur.getGroenValue(), kleur.getBlauwValue()));
		...
		String hrgb = "#";
		hrgb = hrgb.concat(hexValue(kleur.getRoodValue()));
		hrgb = hrgb.concat(hexValue(kleur.getGroenValue()));
		hrgb = hrgb.concat(hexValue(kleur.getBlauwValue()));
